def build_autoencoder(model_name, shape, samples):
    ...
    # h_deconv1g = tf.nn.relu(conv2d(h_deconv1f, weight_variable([5, 5, 8, 8])))
    # h_deconv1h = tf.nn.relu(conv2d(h_deconv1g, weight_variable([5, 5, 8, 1])))
...
def main():
    ...
    batch_size, x, y_image = build_autoencoder(
